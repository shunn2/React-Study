...
const DetailPage: React.FC = () => {
  ...
  return (
    <Container>
      ...
      {selectedTab === "stats" && (
        <Stats isLoading={pokemonQueryResult.isLoading || speciesQueryResult.isLoading} color={color} stats={stats} />
      )}
      {selectedTab === "evolution" && (
        <Evolution id={id} isLoading={speciesQueryResult.isLoading} color={color} url={evolutionChainUrl} />
      )}
    </Container>
  );
};
